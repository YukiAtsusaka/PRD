...
#
# Pairwise SPLIT: Neutral (control) vs Inclusive history (treatment).
# Sibling file: haas-lindstam-2023-exclusive.csv (Neutral vs Exclusive).
...
# This file keeps treat 0 (Neutral) and Inclusive; relabels Inclusive -> 1.
